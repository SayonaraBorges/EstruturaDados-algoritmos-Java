...
import cursoestruturadedadosjava.teste.Contato;
...
public class Exer06 {
    ...
    public static void main(String[] args) {
        ...
        //criar um menu para que o usuário escolher opção
        int opcao = 1;
        while (opcao != 0) {
    ...
    private static void excluirPorPosicao(Scanner scan, Lista<Contato> lista) {
        int pos = lerInformacaoInt("Entre com a posição a ser excluída ", scan);
        try {
            lista.remove(pos);
    ...
    private static void adicionarContatoFinal(Scanner scan, Lista<Contato> lista) {
        ...
        System.out.println(contato); //toString de Contato
    ...
    protected static int obterOpcaoMenu(Scanner scan) {
        ...
        while (!entradaValida) {
            ...
            System.out.println("2: Adiciona contato em posição específica ");
            ...
            System.out.println("9: Vefica tamanho do vetor ");
